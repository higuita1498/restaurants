...
//todas las paginas que estan llamadas dentro de un stack de navegacion se les puede sacar el {navigation}
export default function Favorites({ navigation }) {
    ...
    useFocusEffect(
        useCallback(() => {
            ...
            setReloadData(false)
            //vamos a ejecutar userLogged y el reloadData cuando cambien su valor
            //tenemos 3 formas como se va a ejecutar este metodo por cambio de userlogged, reloadData y useFocusEffect
...
function Restaurant({ restaurant, setLoading, toastRef, navigation, setReloadData }) {
    ...
    const removeFavorite = async() => {
        ...
        if (response.statusResponse) {
            /*NOTA.
            este metodo se llama en el usefoccuseffect el cual es una 
            de las causales por el cual el usefocuseefect se va a ejecutar.*/
            setReloadData(true)
